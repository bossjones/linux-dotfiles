...
brew "gst-plugins-good", args: ["with-pulseaudio"]
...
brew "zsh"
brew "bossjones/scarlett-deps/cmu-sphinxbase", args: ["devel", "with-python"]
# Lightweight speech recognition engine for mobile devices 5prealpha
brew "bossjones/scarlett-deps/cmu-pocketsphinx", args: ["with-python"]
